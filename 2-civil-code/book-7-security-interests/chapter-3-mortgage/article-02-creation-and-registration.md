...
article_number: 2
slug: article-02-creation-and-registration
title: "Creation and Registration"
last_revised: 2025-11-18
status: active
---

# Article 2 – Creation and Registration
...
7. Registration is effected by submission of the required documents and payment of the prescribed fees. The registrar examines the documents for formal compliance and, if satisfied, enters the mortgage in the register.

8. A mortgage may secure present or future obligations, provided they are sufficiently determined or determinable. If the obligation is contingent or its amount is variable, the mortgage agreement must specify the maximum amount secured.

9. A mortgage may be granted to secure obligations of the mortgagor or of a third party. In the latter case, the mortgagor has recourse against the principal debtor for any loss suffered due to enforcement of the mortgage.
...
13. The mortgagor may register a notice of satisfaction or release if the mortgagee fails to do so after the obligation is satisfied. The mortgagor must provide evidence of satisfaction and give notice to the mortgagee. If the mortgagee does not object within a specified period, the registrar may cancel the registration.
