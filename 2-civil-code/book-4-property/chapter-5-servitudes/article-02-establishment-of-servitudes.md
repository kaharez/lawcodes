...
article_number: 2
slug: article-02-establishment-of-servitudes
title: "Establishment of Servitudes"
...
5. Discontinuous servitudes and continuous servitudes that are not apparent cannot be acquired by prescription.

6. A servitude is continuous if its exercise does not require current action by the holder, such as a right to receive light or water. A servitude is discontinuous if its exercise requires repeated action, such as a right of way.

7. A servitude is apparent if its existence is revealed by external signs or works, such as a path, canal, or window. A servitude is non-apparent if no such signs exist.

8. Legal servitudes imposed by law for public utility or necessity take effect without the need for a title, registration, or prescription, and are governed by the specific provisions of law establishing them.
