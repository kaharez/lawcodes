...
chapter: 7
chapter_name: "Specific Contracts"
article_number: 2
slug: article-02-lease-loan-and-mandate
title: "Lease, Loan, and Mandate"
last_revised: 2025-11-18
status: active
---

# Article 2 – Lease, Loan, and Mandate

1. Lease is a contract whereby the lessor grants the lessee the use and enjoyment of a thing for a fixed or indeterminate period in exchange for rent.

2. The lessor must deliver the thing in a condition suitable for the agreed use and maintain it in that condition during the lease. The lessee must use the thing as a prudent person, pay the rent, and return the thing at the end of the lease.

3. The lessee may not transfer the lease or sublet the thing without the consent of the lessor, unless otherwise agreed or authorized by law.

4. Loan for use (commodatum) is a gratuitous contract whereby the lender delivers a thing to the borrower for use, with the obligation to return the same thing. The borrower may use the thing only for the purpose agreed and must return it upon demand or expiry of the agreed term.
...
9. Mandate is a contract whereby the mandatary undertakes to perform juridical acts on behalf of and in the interest of the mandator.

10. The mandatary must execute the mandate with the care of a prudent administrator, within the limits of the authority granted, and must account for all actions and property received.

11. The mandator must reimburse expenses incurred by the mandatary in executing the mandate and must indemnify the mandatary against liabilities reasonably incurred.
